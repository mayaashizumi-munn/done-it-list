...
const onDoneItSubmit = async () => {
    ...
    toast.add({
        severity: "success",
        summary: "Done It Added",
        detail: "New done it created",
        life: 3000,
    })
}
...
const onDoneItEdited = async () => {
    ...
    toast.add({
        severity: "success",
        summary: "Done It Edited",
        detail: "Done it successfully edited",
        life: 3000,
    })
}
...
const onDoneItSubmitFailed = () => {
    toast.add({
        severity: "error",
        summary: "Error Creating Done It",
        detail: "Please try again",
        life: 3000,
    })
}
...
const deleteTodo = (todoId: number, showToast = true) => {
    deleteFromDb(TODO_DB, todoId)
        .then(() => {
            if (showToast) {
                toast.add({
                    severity: "success",
                    summary: "Todo Removed",
